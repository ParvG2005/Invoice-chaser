...
describe("llmExtractInvoice", () => {
  it("maps a valid tool_use payload to ParsedInvoice", async () => {
    const client = mockClient({
      ...
      lineItems: [{ description: "TB/TRUFIX 110 GREY 20KG", qty: 50, rate: 250, discountPct: 15.25, taxRatePct: 18, hsnCode: "38245090" }],
    });
    ...
    expect(r?.invoice.lineItems?.[0].hsnCode).toBe("38245090");
