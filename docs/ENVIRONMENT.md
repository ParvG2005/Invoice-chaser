...
| `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` | Clerk (client) | ⬜ | ⬜ | ⬜ | Clerk dashboard — dev instance for local/preview, prod instance for Prod (Task 5) |
| `CLERK_SECRET_KEY` | Clerk (server) | ⬜ | ⬜ | ⬜ | Clerk dashboard, same split as above |
