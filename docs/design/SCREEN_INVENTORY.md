...
| 10 | Imports wizard | Guided Tally/CSV import | Upload Masters, upload vouchers, review preview/warnings, confirm import, download mapping report | Upload steps, preview table, created/updated/skipped/errored counts | 2 (parser) / 3 (UI) |
